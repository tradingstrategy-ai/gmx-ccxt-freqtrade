...
class IchiV3_LS_Static(IStrategy):
    """
    IchiV3_LS_Static - for static config bots
...
└──────────────┴────────┴──────────────┴─────────────────┴──────────────┴─────────────────┴────────────────────────┴──────────────────────┘
    ...
    def __init__(self, config):
        ...
        self._cache_file = os.path.join(os.path.dirname(__file__), "market_cap_cache.json")
    ...
    buy_params = {
        ...
        'price_velocity_window': 9,      # Velocity calculation window
    }
